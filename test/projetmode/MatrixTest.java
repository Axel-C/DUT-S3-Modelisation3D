...
public class MatrixTest {
	...
	public void testTranslationMatrix() {
		Matrix actualMatrix = Matrix.getTranslationMatrix(new Matrix(new double[][] {
			{2}, {2}, {3}, {1}}));
	...
	public void testScalingMatrix() {
		Matrix actualMatrix = Matrix.getScalingMatrix(new Matrix(new double[][] {
			{4}, {2}, {7}, {1}}));
		Matrix expectedMatrix = new Matrix(
	...
	public void testXRotationMatrix() {
		...
		Matrix expectedMatrix = new Matrix((new double[][] { { 1, 0, 0, 0 }, { 0, Math.cos(angleInRadians), -Math.sin(angleInRadians), 0 },
	...
	public void testYRotationMatrix() {
		...
		Matrix expectedMatrix = new Matrix(new double[][] { { Math.cos(angleInRadians), 0, Math.sin(angleInRadians), 0 },
	...
	public void testZRotationMatrix() {
		...
		Matrix expectedMatrix = new Matrix(new double[][] { { Math.cos(angleInRadians), -Math.sin(angleInRadians), 0, 0 },
