...
public class PointTest {
	...
	public void testTranslate() {
		...
		Matrix columnMatrix = new Matrix(new double[][] { { 5 }, { 20 }, { 5 }, { 1 } });
		Point expectedPoint = new Point(actualPoint.getX() + columnMatrix.getElement(0, 0),
				actualPoint.getY() + columnMatrix.getElement(1, 0), actualPoint.getZ() + columnMatrix.getElement(2, 0));
